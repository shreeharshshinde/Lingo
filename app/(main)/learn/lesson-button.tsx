                    ...
                    <div className='h-[102px] w-[102px] relative'>
                        ...
                        >
                            <Button size={"rounded"} variant={locked ? "locked" : "secondary"} className='h-[70px] w-[70px] border-b-8'>
                                <Icon className={cn("!h-8 !w-8", locked ? "fill-neutral-400 text-neutral-400 stroke-neutral-400" : "fill-primary-foreground text-primary-foreground", isCompleted && "fill-none stroke-[4]") }/>
                            </Button>
                        </CircularProgressbarWithChildren>
